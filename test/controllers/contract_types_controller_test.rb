...
class ContractTypesControllerTest < ActionController::TestCase
  ...
  test "should create contract_type" do
    assert_difference('ContractType.count') do
      post :create, contract_type: { description: @contract_type.description, name: @contract_type.name, value: @contract_type.value, value_type: @contract_type.value_type }
    end
  ...
  test "should update contract_type" do
    patch :update, id: @contract_type, contract_type: { description: @contract_type.description, name: @contract_type.name, value: @contract_type.value, value_type: @contract_type.value_type }
    assert_redirected_to contract_type_path(assigns(:contract_type))
  end
